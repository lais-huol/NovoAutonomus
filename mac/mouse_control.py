...
sub.setsockopt_string(zmq.SUBSCRIBE, u'surface')
...
while True:
    ...
    if gaze_position[u'name'] == surface_name:
        gaze_on_screen = gaze_position[u'gaze_on_srf']
        if len(gaze_on_screen) > 0:
            ...
            raw_x, raw_y = gaze_on_screen[-1][u'norm_pos']
